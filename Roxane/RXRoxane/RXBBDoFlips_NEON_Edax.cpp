...
bool RXBitBoard::do_flips_A1(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X8000000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_B1(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X4000000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_C1(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X2000000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_D1(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X1000000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_E1(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0800000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_F1(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0400000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_G1(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0200000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_H1(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0100000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_A2(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0080000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_B2(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0040000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_C2(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0020000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_D2(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0010000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_E2(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0008000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_F2(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0004000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_G2(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0002000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_H2(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0001000000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_A3(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000800000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_B3(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000400000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_C3(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000200000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_D3(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000100000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_E3(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000080000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_F3(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000040000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_G3(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000020000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_H3(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000010000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_A4(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000008000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_B4(unsigned long long& P, unsigned long long& O) {
    ...
    uint64_t flipped = vget_lane_u64(vorr_u64(vget_low_u64(flip), vget_high_u64(flip)), 0);
    if(flipped) {
        P |= (flipped | 0X0000004000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_C4(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000002000000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_F4(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000400000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_G4(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000200000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_H4(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000100000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_A5(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000080000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_B5(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000040000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_C5(unsigned long long& P, unsigned long long& O) {
   ...
   if(flipped) {
        P |= (flipped | 0X0000000020000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_F5(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000004000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_G5(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000002000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_H5(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000001000000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_A6(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000800000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_B6(unsigned long long& P, unsigned long long& O) {
   ...
   if(flipped) {
        P |= (flipped | 0X0000000000400000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_C6(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000200000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_D6(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000100000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_E6(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000080000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_F6(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000040000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_G6(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000020000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_H6(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000010000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_A7(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000008000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_B7(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000004000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_C7(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000002000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_D7(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000001000ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_E7(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000800ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_F7(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000400ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_G7(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000200ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_H7(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000100ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_A8(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000080ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_B8(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000040ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_C8(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000020ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_D8(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000010ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_E8(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000008ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_F8(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000004ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_G8(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000002ULL);
        O ^= flipped;
        return true;
    }
...
bool RXBitBoard::do_flips_H8(unsigned long long& P, unsigned long long& O) {
    ...
    if(flipped) {
        P |= (flipped | 0X0000000000000001ULL);
        O ^= flipped;
        return true;
    }
